...
<section class="bg-light py-3 py-md-5">
   ...
   <center><p class="titre" style="font-size:35px; font-familly:Gabriola;"> Autolink Cameroun</p></center>
        ...
        @endif
                  ...
                  <div class="col-12">
                    <div class="d-grid my-3">
                      <button class="btn btn-primary btn-lg" type="submit" name="search">S'identifier</button>
                    </div>
                  </div>
                
                  <div class="col-12">
                    <p class="m-0 text-secondary text-center">Vous n’avez pas de compte? <a href="/" class="link-primary text-decoration-none">S’enregistrer</a></p>
                  </div>

            <div class="row">
                <div class="col-12">
                  <p class="mt-5 mb-4">Se Connecter via</p>
