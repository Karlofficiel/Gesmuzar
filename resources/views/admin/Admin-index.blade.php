...
<p class="bottom"><u>Statistique de l'application</u></p> 

<div  class="gauche">
                      

        <div id="block">Utilisateur <br> Connecter <br><br>
                <!-- {{ $userCount }} -->
                  2
        </div>

        <a href="/Allutilisateurs">
                <div id="block">Compte <br> Crée <br><br>
                        {{ $userCount }}
                </div>
        </a>

      <a href="/Allreservations">
            <div id="block">Total <br> Reservations <br><br>
                        {{ $voitureCount }}
                </div>
      </a>
 
</div>
<div class="calendar" style="margin-left:50px; margin-bottom:50px;">
...
<style>
    .reponse .effacer{
      ...
      .gauche  {
            position: absolute;
            background-color:tranredsparent;
            top:290px;
            left: 250px;
            height: 400px;
            width:1000px;    
