...
<form action="searchVadmin" method="get">
...
<div  class="gauche">
<p style="font-size:80px;color:white !important;font-family:gabriola;">Tous les Voitures de l'application </p>
               ...
               <td><input type="checkbox" class="checkthis"/></td>
                    ...
                    <td>
                        ...
                        <button class="btn btn-danger btn-sm" data-title="Delete" data-toggle="modal" data-target="#delete" 
                                onclick="return confirm('Voulez-vous vraiment supprimer cette voiture ?')" ><a href="/Allvoitures/{{ $item->id }}" style="color:white;">Supprimer</a>
