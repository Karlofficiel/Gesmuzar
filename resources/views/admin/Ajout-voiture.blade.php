...
<div  class="gauche">
<p style="font-size:80px;color:white !important;font-family:gabriola;text-align:center;margin-right:280px"> Formulaire d'ajout de voiture </p>
    <div class="form-container">
        <h1>Ajouter une Voiture</h1>
        <form action="/ajout" method="post" style="width:900px;">
          @csrf
            ...
            <div class="form-group">
                <label for="car-model">Prix voiture (Fcfa) </label>
                <input type="number" id="prixvoiture" name="prixvoiture"  required>
            </div>
            <div class="form-group">
