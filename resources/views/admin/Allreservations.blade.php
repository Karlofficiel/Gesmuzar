...
<div  class="gauche">
     <p style="font-size:80px;color:white !important;font-family:gabriola;">Tous les Reservations de l'application </p>
...
<table id="mytable" class="table table-bordred table-striped">
      ...
      @foreach ( $voiture as $item )
         ...
         <td>{{ $item-> statut }}</td>
          ...
          <button class="btn btn-danger btn-sm" data-title="Delete" data-toggle="modal" data-target="#delete"  onclick="return confirm('Voulez-vous vraiment supprimer cette reservation ?')">
            <a href="/Allreservations/{{ $item->id }}" id="bouton">Supprimer</a>
