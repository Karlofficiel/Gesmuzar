...
<div class="gauche">
   ...
   <nav>
       <p class="p1"><b>Vendeur:</b> FRED-MUZAR <br> pk 14 original <br> 1200 village</p><br>
       <p class="p2" style="margin-left:30px;"><b>Acheteur: {{ auth()->user()->name }} </b></p>
   </nav>
   @foreach ( $voiture as $item )
   <div class="div1">
   <nav>
            <h4>Date de facturation</h4>
            <p><td>{{ $item-> created_at}}</td></p>
        </nav>
        <nav>
        ...
        <nav>
            <h4>action avancer</h4>
            <p><td>achat de voiture</td></p>
        </nav>
        <nav>
            <h4>statut-voiture</h4>
            <p><td>vente</td></p>
        </nav>
        
   </div>

<table class="w3-table w3-striped w3-bordered w3-card-4" id="tablefacture">
  <thead>
...
<a href="{{ route('facture.download') }}">
   <input type="submit" value="Télécharger ma Facture" class="bouton">
</a>
